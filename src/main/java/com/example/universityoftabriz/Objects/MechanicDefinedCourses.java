...
public class MechanicDefinedCourses extends DefinedCourses{
    public MechanicDefinedCourses(Long id, Long teacher_id, Long course_id, Date primary_day, Time time_of_primary_day, Date secondary_day, Time time_of_secondary_day, int class_n, Date exam_date, int capacity) {
        this.id = id;
